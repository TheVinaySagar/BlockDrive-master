...
const Home = ({
            ...
            >
              <div className="card-body property2-content">
                <div className="d-flex flex-wrap align-items-center">
                  {/* Left side - text */}
                  <div className="col-lg-6 col-sm-6 p-0 text-center">
                    <h3 className="mb-3">Welcome {currentUser?.username}</h3>
                    <p className="mb-5">
                      You have uploaded {getAllUserFiles?.length} private and public
                      files, Your data is secure on blockchain
                      "Your key your Data"
                    </p>
                  </div>
                  ...
                  {/* Right side - image */}
                  <div className="col-lg-6 col-sm-6 p-0 d-flex justify-content-center">
                    <img
                      src="../assets/images/layouts/mydrive/background.png"
                      alt="welcome"
                      style={{
                        width: "100%",
                        height: "100%",
              ...
              <div class="card-body">
                <ul class="list-inline p-0 mb-0 row align-items-center">
                  <li class="col-lg-6 col-sm-6 mb-3 mb-sm-0">
                    ...
                    >
                      <div>
                        <IoCloudUpload size={120} color="purple" />
                  ...
                  <li class="col-lg-6 col-sm-6">
                    ...
                    >
                      <div>
                        <img
                          src="../assets/images/HomeProfilePhoto.png"
  ...
  {/* Background Image */}
  <img
    src="../assets/images/custom-banner.png"
    alt="background"
    className="img-fluid w-100"
  />

  {/* Floating Row */}
  <div className="row align-items-center justify-content-center position-absolute top-50 start-50 translate-middle w-100 px-3" style={{ zIndex: 10 }}>
